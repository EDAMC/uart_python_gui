...
#    May 10, 2023 10:48:49 PM +03  platform: Windows NT
...
class serial_com_top:
    def __init__(self, top=None):
        ...
        self.sec_ch_val_lbl.configure(text='''Значение 2-го канала''')
        ...
        self.check_params_btn.place(relx=0.609, rely=0.413, height=24, width=217)
        ...
        self.amp_pos_entry_ch2 = tk.Entry(self.top)
        self.amp_pos_entry_ch2.place(relx=0.376, rely=0.102, height=20
                , relwidth=0.105)
        self.amp_pos_entry_ch2.configure(background="white")
        self.amp_pos_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.amp_pos_entry_ch2.configure(font="TkFixedFont")
        self.amp_pos_entry_ch2.configure(foreground="#000000")
        self.amp_pos_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.amp_pos_entry_ch2.configure(highlightcolor="black")
        self.amp_pos_entry_ch2.configure(insertbackground="black")
        self.amp_pos_entry_ch2.configure(selectbackground="#c4c4c4")
        self.amp_pos_entry_ch2.configure(selectforeground="black")

        self.amp_neg_entry_ch2 = tk.Entry(self.top)
        self.amp_neg_entry_ch2.place(relx=0.376, rely=0.204, height=20
                , relwidth=0.105)
        self.amp_neg_entry_ch2.configure(background="white")
        self.amp_neg_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.amp_neg_entry_ch2.configure(font="TkFixedFont")
        self.amp_neg_entry_ch2.configure(foreground="#000000")
        self.amp_neg_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.amp_neg_entry_ch2.configure(highlightcolor="black")
        self.amp_neg_entry_ch2.configure(insertbackground="black")
        self.amp_neg_entry_ch2.configure(selectbackground="#c4c4c4")
        self.amp_neg_entry_ch2.configure(selectforeground="black")
        ...
        self.time_pos_entry_ch2 = tk.Entry(self.top)
        self.time_pos_entry_ch2.place(relx=0.376, rely=0.283, height=20
                , relwidth=0.105)
        self.time_pos_entry_ch2.configure(background="white")
        self.time_pos_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.time_pos_entry_ch2.configure(font="TkFixedFont")
        self.time_pos_entry_ch2.configure(foreground="#000000")
        self.time_pos_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.time_pos_entry_ch2.configure(highlightcolor="black")
        self.time_pos_entry_ch2.configure(insertbackground="black")
        self.time_pos_entry_ch2.configure(selectbackground="#c4c4c4")
        self.time_pos_entry_ch2.configure(selectforeground="black")

        self.time_neg_entry_ch2 = tk.Entry(self.top)
        self.time_neg_entry_ch2.place(relx=0.376, rely=0.385, height=20
                , relwidth=0.105)
        self.time_neg_entry_ch2.configure(background="white")
        self.time_neg_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.time_neg_entry_ch2.configure(font="TkFixedFont")
        self.time_neg_entry_ch2.configure(foreground="#000000")
        self.time_neg_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.time_neg_entry_ch2.configure(highlightcolor="black")
        self.time_neg_entry_ch2.configure(insertbackground="black")
        self.time_neg_entry_ch2.configure(selectbackground="#c4c4c4")
        self.time_neg_entry_ch2.configure(selectforeground="black")

        self.time_pause_entry_ch2 = tk.Entry(self.top)
        self.time_pause_entry_ch2.place(relx=0.376, rely=0.465, height=20
                , relwidth=0.105)
        self.time_pause_entry_ch2.configure(background="white")
        self.time_pause_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.time_pause_entry_ch2.configure(font="TkFixedFont")
        self.time_pause_entry_ch2.configure(foreground="#000000")
        self.time_pause_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.time_pause_entry_ch2.configure(highlightcolor="black")
        self.time_pause_entry_ch2.configure(insertbackground="black")
        self.time_pause_entry_ch2.configure(selectbackground="#c4c4c4")
        self.time_pause_entry_ch2.configure(selectforeground="black")

        self.period_entry_ch2 = tk.Entry(self.top)
        self.period_entry_ch2.place(relx=0.376, rely=0.567, height=20
                , relwidth=0.105)
        self.period_entry_ch2.configure(background="white")
        self.period_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.period_entry_ch2.configure(font="TkFixedFont")
        self.period_entry_ch2.configure(foreground="#000000")
        self.period_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.period_entry_ch2.configure(highlightcolor="black")
        self.period_entry_ch2.configure(insertbackground="black")
        self.period_entry_ch2.configure(selectbackground="#c4c4c4")
        self.period_entry_ch2.configure(selectforeground="black")

        self.numpack_entry_ch2 = tk.Entry(self.top)
        self.numpack_entry_ch2.place(relx=0.376, rely=0.646, height=20
                , relwidth=0.105)
        self.numpack_entry_ch2.configure(background="white")
        self.numpack_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.numpack_entry_ch2.configure(font="TkFixedFont")
        self.numpack_entry_ch2.configure(foreground="#000000")
        self.numpack_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.numpack_entry_ch2.configure(highlightcolor="black")
        self.numpack_entry_ch2.configure(insertbackground="black")
        self.numpack_entry_ch2.configure(selectbackground="#c4c4c4")
        self.numpack_entry_ch2.configure(selectforeground="black")

        self.time_frame_entry_ch2 = tk.Entry(self.top)
        self.time_frame_entry_ch2.place(relx=0.376, rely=0.748, height=20
                , relwidth=0.105)
        self.time_frame_entry_ch2.configure(background="white")
        self.time_frame_entry_ch2.configure(disabledforeground="#a3a3a3")
        self.time_frame_entry_ch2.configure(font="TkFixedFont")
        self.time_frame_entry_ch2.configure(foreground="#000000")
        self.time_frame_entry_ch2.configure(highlightbackground="#d9d9d9")
        self.time_frame_entry_ch2.configure(highlightcolor="black")
        self.time_frame_entry_ch2.configure(insertbackground="black")
        self.time_frame_entry_ch2.configure(selectbackground="#c4c4c4")
        self.time_frame_entry_ch2.configure(selectforeground="black")
        ...
        self.period_lbl.configure(text='''PERIOD us''')
        ...
        self.time_frame_lbl.configure(text='''TIME_FRAME us''')

        self.stimulation_start_btn = tk.Button(self.top)
        self.stimulation_start_btn.place(relx=0.609, rely=0.492, height=24
                , width=217)
        self.stimulation_start_btn.configure(activebackground="#d3ab6d")
        ...
        self.stimulation_start_btn.configure(disabledforeground="#a3a3a3")
        ...
        self.stimulation_stop_btn = tk.Button(self.top)
        self.stimulation_stop_btn.place(relx=0.609, rely=0.567, height=24
                , width=217)
        self.stimulation_stop_btn.configure(activebackground="#d3ab6d")
        self.stimulation_stop_btn.configure(activeforeground="black")
        self.stimulation_stop_btn.configure(background="#e35e5e")
        self.stimulation_stop_btn.configure(compound='left')
        self.stimulation_stop_btn.configure(disabledforeground="#d3ab6d")
        self.stimulation_stop_btn.configure(font="-family {Terminal_Hex} -size 9 -weight bold")
        self.stimulation_stop_btn.configure(foreground="#000000")
        self.stimulation_stop_btn.configure(highlightbackground="#ffffff")
        self.stimulation_stop_btn.configure(highlightcolor="black")
        self.stimulation_stop_btn.configure(pady="0")
        self.stimulation_stop_btn.configure(text='''Конец стимуляции''')
        self.stimulation_stop_btn.configure(command=stop_stimulation)
...
def check_parameters():
    global ser, com_selected, br_selected,amp_pos_ch1,amp_pos_ch2,amp_neg_ch1,amp_neg_ch2,\
    time_pos_ch1,time_pos_ch2,time_neg_ch1,time_neg_ch2,time_pause_ch1,time_pause_ch2,\
    period_ch1,period_ch2,numpack_ch1,numpack_ch2,time_frame_ch1 ,time_frame_ch2,num_of_frames_ch2, connected
    parameters_list_str = ''
    ...
    parameters_list_str = "com_selected,"    + com_selected+"\n"+\
                          ...
                          "amp_pos_ch2,"     + amp_pos_ch2+"\n"+\
                          "amp_neg_ch1,"     + amp_neg_ch1+"\n"+\
                          "amp_neg_ch2,"     + amp_neg_ch2+"\n"+\
                          "time_pos_ch1,"    + time_pos_ch1+"\n"+\
                          "time_pos_ch2,"    + time_pos_ch2+"\n"+\
                          "time_neg_ch1,"    + time_neg_ch1+"\n"+\
                          "time_neg_ch2,"    + time_neg_ch2+"\n"+\
                          "time_pause_ch1,"  + time_pause_ch1+"\n"+\
                          "time_pause_ch2,"  + time_pause_ch2+"\n"+\
                          "period_ch1,"      + period_ch1+"\n"+\
                          "period_ch2,"      + period_ch2+"\n"+\
                          "numpack_ch1,"     + numpack_ch1+"\n"+\
                          "numpack_ch2,"     + numpack_ch2+"\n"+\
                          "time_frame_ch1,"  + time_frame_ch1+"\n"+\
                          "time_frame_ch2,"  + time_frame_ch2+"\n"+\
    ...
    if (not connected):
        ser = serial.Serial(port = com_selected, baudrate=br_selected, timeout = 1)
        print("connected")
        connected = 1
    # time to cycles
    f = 72 # 72 MHz
    # N_cycles_pos_ch_1 = f * int(time_pos_ch1)
    # N_cycles_neg_ch_1 = f * int(time_neg_ch1)
    N_cycles_pos_ch_1 =  int(time_pos_ch1)
    N_cycles_neg_ch_1 =  int(time_neg_ch1)

    print (N_cycles_pos_ch_1, N_cycles_neg_ch_1)
    ...
    period_bytes         = bytes(int(period_ch1))
    init_time_bytes      = bytes(int(period_ch1) - int(time_neg_ch1) - int(time_pos_ch1) - int(time_pause_ch1))
    ...
    print(amp_pos_val,amp_neg_val)

    time_relax = (int(time_frame_ch1)-int(numpack_ch1)*int(period_ch1))/1000
    if (time_relax < 1):
        time_relax = 1
    else:
        time_relax = math.floor((int(time_frame_ch1)-int(numpack_ch1)*int(period_ch1))/1000)
    ...
    print("first read "+str(my_char))
    my_char = ser.readline()
    print("second read "+str(my_char))
    my_char = ser.readline()
    print("third read "+str(my_char))
    init_serial_data = [0x1,0x1]
    serial_data = init_packet+time_packet+amp_packet+num_packet+end_packet
    print("len of packet", len(serial_data))
    print(serial_data)
    #check_data = [0x22,0x21,0x22,0x01,0x22,0x21,0x22]
    ser.write(serial.to_bytes(init_serial_data))
    my_char = ser.readline()
    ...
    my_char = ser.readline()
    print(my_char)
    #gui.Scrolledtext1.option_clear()
    gui.Scrolledtext1.insert(END, my_char)
def start_stimulation():
    ...
    if(not connected):
        ...
        connected = 1
    #print(ser)
    ser.write(serial.to_bytes(check_data))
    my_char = ser.readline()
    print(my_char)
    
    # gui.Scrolledtext1.insert(END,value)
...
def stop_stimulation():
    ...
    com_selected = gui.Com_box.get()
    br_selected  = gui.Br_box.get()
    stop_data = [0x22,0x21,0x22,0x00,0x22,0x21,0x22]
    gui.Scrolledtext1.insert(END,"STOP STIMULATION\n")
    print(com_selected, br_selected)
    if(not connected):
        ser = serial.Serial(port = com_selected, baudrate=br_selected, timeout = 2.5)
        connected = 1
    #print(ser)
    ser.write(serial.to_bytes(stop_data))
    my_char = ser.readline()
    print(my_char)
    # gui.Scrolledtext1.insert(END,value)
# def read_char():
...
def load_file ():
    ...
    gui.amp_neg_entry_ch1.insert    (0,data[4][1])
    gui.amp_neg_entry_ch2.insert    (0,data[5][1])
    gui.time_pos_entry_ch1.insert   (0,data[6][1])
    gui.time_pos_entry_ch2.insert   (0,data[7][1])
    gui.time_neg_entry_ch1.insert   (0,data[8][1])
    gui.time_neg_entry_ch2.insert   (0,data[9][1])
    gui.time_pause_entry_ch1.insert (0,data[10][1])
    gui.time_pause_entry_ch2.insert (0,data[11][1])
    gui.period_entry_ch1.insert     (0,data[12][1])
    gui.period_entry_ch2.insert     (0,data[13][1])
    gui.numpack_entry_ch1.insert    (0,data[14][1])
    gui.numpack_entry_ch2.insert    (0,data[15][1])
    gui.time_frame_entry_ch1.insert (0,data[16][1])
    gui.time_frame_entry_ch2.insert (0,data[17][1])
    gui.num_of_frames_entry_ch1.insert(0,data[18][1])
def save_file ():
    parameters_list_str = ''
    com_selected    = gui.Com_box.get()
    br_selected     = gui.Br_box.get()
